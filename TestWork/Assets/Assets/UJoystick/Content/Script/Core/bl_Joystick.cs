...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public Vector3 inputAlignWithCameraDirection
    {
        get {
            var dir = camera.transform.TransformDirection(InputValue);
            var moveDirection = dir;
            moveDirection.y = 0;
            return moveDirection.normalized * dir.magnitude;
        }
    }
}